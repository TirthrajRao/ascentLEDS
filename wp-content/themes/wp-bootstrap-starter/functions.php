...
function wp_bootstrap_starter_setup() {
    ...
    register_nav_menus( array(
        'footer-menu-1' => esc_html__( 'Footer Menu 1', 'wp-bootstrap-starter' ),
    ) );
...
function wp_bootstrap_starter_scripts() {
    ...
    wp_enqueue_style( 'wp-custom-css', get_template_directory_uri() . '/inc/assets/css/custom.css', true, '',);
    //Color Scheme
    ...
    wp_enqueue_script( 'wp-bootstrap-starter-custom-js', get_template_directory_uri() . '/inc/assets/js/custom.js', array(), '20151215', true );
